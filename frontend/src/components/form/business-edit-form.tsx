...
import { useAdminUpdateBusiness } from "@/lib/queries/admin/businesses";
import type {
	BusinessCategory,
	BusinessPlan,
	BusinessResponse,
...
export function BusinessEditForm({
	...
	className,
	...props
}: Readonly<BusinessEditFormProps>) {
	...
	const handleSaved = () => {
		...
		void navigate({ to: "/admin/businesses" });
	};
