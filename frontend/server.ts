 ...
 * AVISO DE ATRIBUIÇÃO
 *
 * Este arquivo foi obtido do repositório oficial do TanStack Router e
 * originalmente desenvolvido por Erik May (github.com/erikmay).
 *
 * Fonte: https://github.com/TanStack/router/blob/main/examples/react/start-bun/server.ts
 * Autores: TanStack Contributors, Erik May
 * Licença: MIT - Copyright (c) TanStack LLC
 *
 * Utilizado neste projeto acadêmico como servidor de produção para a aplicação
 * TanStack Start com Bun, por oferecer uma estratégia eficiente de carregamento
 * de ativos estáticos sem a necessidade de implementação do zero.
 */
